...
for ind in range(0,25):
    ...
    img_0=np.reshape(img_0, (9000000,3))
    pca=PCA(1)
    pca.fit(img_0)
    print('components:',pca.components_)
    print('variances:',pca.explained_variance_)
    img_pca=pca.transform(img_0)
    print('transformed data:',img_pca)
    img_pca=np.reshape(img_pca, (3000,3000))
    k=0
